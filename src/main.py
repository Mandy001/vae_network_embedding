...
from libnrl.vae_dngr import DNGR
import time
import sys
...
def parse_args():
    ...
    parser.add_argument('--method', required=True, choices=['node2vec', 'deepWalk', 'line', 'gcn', 'grarep', 'tadw', 'dngr'],
...
if __name__ == "__main__":
    ...
    # command = "--method dngr --label-file ../data/cora/cora_labels.txt --input ../data/cora/cora_edgelist.txt --output cora_vec_all.txt"
